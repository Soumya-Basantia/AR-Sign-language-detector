...
class PredictionMemory:
    ...
    # Expanded bigram co-occurrence table (word → likely next words)
    _BIGRAMS: Dict[str, List[str]] = {
        "I":      ["WANT", "NEED", "AM", "LOVE", "FEEL", "GO", "SEE", "HAVE"],
        "YOU":    ["ARE", "CAN", "WILL", "DO", "HELP", "KNOW", "WANT"],
        "WANT":   ["WATER", "FOOD", "HELP", "MORE", "TO", "GO", "SLEEP", "HOME"],
        "NEED":   ["HELP", "WATER", "FOOD", "DOCTOR", "MORE", "TO", "REST", "MEDICINE"],
        "PLEASE": ["HELP", "STOP", "WAIT", "COME", "GIVE", "CALL", "TELL"],
        "THANK":  ["YOU"],
        "MORE":   ["WATER", "FOOD", "PLEASE", "TIME"],
        "NO":     ["MORE", "PAIN", "STOP", "PROBLEM", "THANKS"],
        "STOP":   ["PLEASE", "NOW", "IT", "HERE"],
        "GO":     ["AWAY", "HOME", "NOW", "TO", "BACK"],
        "COME":   ["HERE", "PLEASE", "NOW", "BACK", "IN"],
        "WATER":  ["PLEASE", "MORE", "NOW", "COLD", "HOT"],
        "FOOD":   ["PLEASE", "MORE", "NOW", "HOT", "GOOD"],
        "DOCTOR": ["PLEASE", "NOW", "HELP", "CALL", "WHERE"],
        "YES":    ["PLEASE", "THANK", "YOU", "I", "SURE"],
        "SORRY":  ["FOR", "ABOUT", "THAT", "PLEASE"],
        "CALL":   ["DOCTOR", "HELP", "POLICE", "ME", "FAMILY"],
        "HELP":   ["ME", "PLEASE", "NOW", "US"],
        "FEEL":   ["PAIN", "SICK", "GOOD", "BAD", "TIRED", "HUNGRY", "COLD", "HOT"],
        "WHERE":  ["IS", "RESTROOM", "BATHROOM", "DOCTOR", "WATER"],
        "CAN":    ["YOU", "I", "WE", "HELP"],
        "HOW":    ["ARE", "DO", "CAN", "MUCH"],
    }
